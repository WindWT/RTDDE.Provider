...
namespace RTDDE.Provider.Enums
{
    public enum PassiveSkillType
    {
        ...
        PANEL_COMP_PARTY_ATTACK_ENHANCE = 153,
        PANEL_COMP_ENEMY_ATTACK_CUT = 154,
        PANEL_COMP_ADD_DAMAGE = 155,
        PANEL_COMP_HEAL_LIFE = 156,
        LIFE_LIMIT_EXPANEL_ATTACK = 157,
        LIFE_LIMIT_ATTRIBUTE_UNIT_GRADEUP = 158,
        CLASS_ATK_COUNT_AND_CHAIN_ATK_UP = 159,
        MAX = 160,
    }
}
